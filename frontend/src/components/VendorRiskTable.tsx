  ...
  if (!vendors || vendors.length === 0) {
    return (
      <div className="bg-white rounded-lg shadow p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Vendor Risk Analysis</h2>
        <p className="text-gray-600 text-sm">No vendor risk data available</p>
      </div>
    );
  }
    ...
    <>
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900">Vendor Risk Analysis</h2>
          <p className="text-sm text-gray-600 mt-1">Click on a row to view detailed risk narrative</p>
        </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[80vh] overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold text-gray-900">Risk Narrative</h3>
            ...
            <div className="px-6 py-4 overflow-y-auto max-h-[60vh]">
              {loadingNarrative ? (
                ...
                <div className="prose prose-sm max-w-none">
                  <p className="text-gray-700 whitespace-pre-wrap">{narrative}</p>
                </div>
              )}
            </div>
