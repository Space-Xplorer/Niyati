    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8 flex justify-between items-start">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Project Niyati - Admin Dashboard</h1>
            <p className="text-gray-600 mt-2">Government Officer - System-Wide View</p>
          </div>
        ...
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Structural Fraud Patterns Detected</h2>
...
const FraudPatternCard: React.FC<FraudPatternCardProps> = ({ title, count, description, color, onClick, isActive }) => {
  ...
  return (
    <button
      onClick={onClick}
      className={`rounded-lg border-2 p-6 text-left transition-all ${colorClasses[color as keyof typeof colorClasses]} ${
